...
public class Chat_room extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatRoomTitle= (TextView) findViewById(R.id.ChatTitle);
        //Get intent extras
        ...
        chatRoomTitle.setTextSize(18);
        Log.d("dk","chat room got"+roomName+userName+address);
        //Set activity title to room name
        setTitle(roomName);

        rootRoomName = FirebaseDatabase.getInstance().getReference().getRoot().child("Database").child(address).child(roomName);
